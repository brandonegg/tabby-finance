...
APP_URL="${LOGIN_EXPO_URL:-exp://${APP_HOST}:${METRO_PORT}/--/login}"
API_BASE_URL="${API_BASE_URL:-http://${APP_HOST}:${METRO_PORT}}"
METRO_STATUS_URL="${METRO_STATUS_URL:-http://${APP_HOST}:${METRO_PORT}/status}"
